...
`gofuroov\multilingual\widgets\ActiveForm` form looks and bahaves in the same way as `\yii\bootstrap\ActiveForm`.
...
- Form With Switcher:
  ...
  ![Form With Switcher](https://raw.githubusercontent.com/gofuroov/yii2-multilingual/master/docs/images/form-with-switcher.png)


- Form Without Switcher:

  ![Form Without Switcher](https://raw.githubusercontent.com/gofuroov/yii2-multilingual/master/docs/images/form-without-switcher.png)
