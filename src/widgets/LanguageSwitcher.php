...
namespace gofuroov\multilingual\widgets;

use Yii;
use yii\helpers\ArrayHelper;
use gofuroov\multilingual\helpers\MultilingualHelper;
...
class LanguageSwitcher extends \yii\base\Widget
{
    ...
    protected $_reservedViews = [
        'links' => '@vendor/gofuroov/yii2-multilingual/src/views/switcher/links',
        'pills' => '@vendor/gofuroov/yii2-multilingual/src/views/switcher/pills',
    ];
